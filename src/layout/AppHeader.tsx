      ...
      <div className="flex w-full items-center justify-between px-4 py-3.5 lg:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/" className="lg:hidden">
            <img className="dark:hidden h-8" src="/aztu-logo-dark.webp" alt="AzTU" />
            <img className="hidden dark:block h-8" src="/aztu-logo-light.png" alt="AzTU" />
          </Link>

          {/* Desktop institution context label */}
          <div className="hidden items-center gap-2 lg:flex">
            <span className="text-sm text-gray-400 dark:text-gray-500">AzTU</span>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="text-gray-300 dark:text-gray-600">
              <path d="M9 18l6-6-6-6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
              İxtisas İnformasiya Sistemi
            </span>
          </div>
        </div>
